...
export interface components {
  schemas: {
    ...
    StorageCreateRequest: WithRequired<
      components["schemas"]["StorageUpdatable"],
      "name"
    > &
    ...
    SubnetCreateRequest: WithRequired<
      components["schemas"]["SubnetUpdatable"],
      "name" | "cidr"
    >;
