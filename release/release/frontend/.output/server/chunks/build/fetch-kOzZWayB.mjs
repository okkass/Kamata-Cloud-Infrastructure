...
import { i as fetchDefaults, j as useRequestFetch } from './server.mjs';
import { u as useAsyncData } from './asyncData-BDnIU8Sz.mjs';
...
const SNAPSHOT = { name: "snapshots" };
const BACKUP = { name: "backups" };
const MACHINE = { name: "virtual-machines", label: "仮想マシン" };
const INSTANCE_TYPE = {
  name: "instance-types",
  label: "インスタンスタイプ"
};
const STORAGE = { name: "storage-pools" };
const NETWORK = { name: "virtual-networks", label: "仮想ネットワーク" };
const IMAGE = { name: "images" };
const USER = { name: "users" };
const ME = { name: "users/me" };
const SECURITY_GROUP = {
  name: "security-groups"
};
const MIDDLEWARE = { name: "middlewares" };
const NODE = { name: "nodes", label: "物理ノード" };
const DISABLE_ROUNDING = false;
const VM_ACTION_CONFIRMATION = {
  stop: {
    title: "停止の確認",
...
export { BACKUP as B, DISABLE_ROUNDING as D, IMAGE as I, ME as M, NODE as N, SNAPSHOT as S, USER as U, VM_ACTION_SUCCESS as V, MACHINE as a, NETWORK as b, VM_ACTION_CONFIRMATION as c, STORAGE as d, INSTANCE_TYPE as e, MIDDLEWARE as f, SECURITY_GROUP as g, useFetch as u };
//# sourceMappingURL=fetch-kOzZWayB.mjs.map
