...
import { defineComponent, ref, withCtx, createVNode, createTextVNode, unref, toDisplayString, computed, useSSRContext } from 'vue';
  ...
  const executeRestoreApi = async (id, name) => {
    ...
    try {
      ...
      addToast({
        ...
        message: result.success ? `バックアップ「${name}」からの復元を開始しました。` : "復元に失敗しました。",
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_UiBaseAlert, { type: "warning" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p${_scopeId2}> この操作を行うと、現在の仮想マシンのデータは完全に上書きされます。<br${_scopeId2}> 復元を実行する前に、現在の状態のバックアップを取得することをお勧めします。 </p>`);
                } else {
                  return [
                    createVNode("p", null, [
                      createTextVNode(" この操作を行うと、現在の仮想マシンのデータは完全に上書きされます。"),
                      createVNode("br"),
                      createTextVNode(" 復元を実行する前に、現在の状態のバックアップを取得することをお勧めします。 ")
                    ])
                  ];
                }
              }),
                ...
                createVNode("div", { class: "border rounded-md bg-white overflow-hidden" }, [
                  ...
                  createVNode("div", { class: "p-4 grid grid-cols-1 gap-y-4 sm:grid-cols-2 sm:gap-x-6 text-sm" }, [
                    createVNode("div", null, [
                      createVNode("span", { class: "block text-xs text-gray-500 mb-1" }, "バックアップ名"),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/MoBackupRestore.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const MoBackupRestore = Object.assign(_sfc_main, { __name: "MoBackupRestore" });

export { MoBackupRestore as M };
//# sourceMappingURL=MoBackupRestore-DxGsGKPY.mjs.map
